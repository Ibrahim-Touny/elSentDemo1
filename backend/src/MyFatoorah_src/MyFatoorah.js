...
const getMayFatoorahApiBaseURL = () => {
    return MYFATOORAH_DEV_API_URL; //process.env.NODE_ENV === 'production' ? MYFATOORAH_PROD_API_URL : MYFATOORAH_DEV_API_URL;
}
...
const getToken = () => {
    ...
    return testToken; //process.env.NODE_ENV === 'production' ? process.env.MYFATOORAH_TOKEN : testToken;
}
 ...
 */
const initiatePayment = async ({ countryId, invoiceAmount }) => {
...
export { executePayment, getPaymentStatus, initiatePayment };